...
export default class Rankflex extends Component {
    render() {
        return (
            <View style={{ marginTop: 0, backgroundColor: "white", marginLeft: 15, marginRight: 15, borderRadius: 20, marginBottom: 20, shadowOffset: { width: 10, height: 10 }, shadowColor: 'black', shadowOpacity: 1, elevation: 3 }}>
